...
const styles = StyleSheet.create({
  ...
  itemEmo: { fontSize: 22 },
  itemBody: { flex: 1 },
  itemTitle: { fontSize: 15.5, fontWeight: font.semibold, color: colors.ink, lineHeight: 20 },
  ...
  removeText: { fontSize: 13, fontWeight: font.semibold, color: colors.coralDeep },
  clear: { paddingVertical: 16, alignItems: 'center', marginTop: 4 },
  clearText: { fontSize: 14.5, color: colors.inkFaint, fontWeight: font.medium },
  emptyRoot: {
    flex: 1,
  ...
  emptyH: { fontSize: 20, fontWeight: font.bold, color: colors.ink, marginBottom: 8 },
  emptyP: {
    fontSize: 15,
  ...
  ctaText: { color: colors.white, fontSize: 16, fontWeight: font.bold },
});
